...
def roundShape(object, type, degree, segments, sideReference, axis=""):
...
# Applying deformation:
roundShape(region, deformationType, roundingDegree, numberSegments, sideReference, deformationAxis)
