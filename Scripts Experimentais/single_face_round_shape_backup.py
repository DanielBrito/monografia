...
''' --------- SIMULATING SELEX RULES (single_face_round_shape.slx): --------- '''
...
# Applying deformation:
roundShape(region, deformationType, roundingDegree, numberSegments, deformationAxis)
...
# TESTING -> Simulating data for labels, degree, segments, type and axis:
labels = ["building", "building_front", "entrance_2", "entrance_2_front"]
roundingDegree = 0.3
numberSegments = 30
deformationType = "front" # front | left | right | bottom | top
deformationAxis = "vertical" # frontal deformation: vertical | horizontal
...
# TESTING -> Simulating data for labels, degree, segments, type and axis:
labels = ["building", "building_front", "entrance_3_top", "entrance_3_top_front"]
roundingDegree = 0.3
numberSegments = 30
deformationType = "front" # front | left | right | bottom | top
deformationAxis = "vertical" # frontal deformation: vertical | horizontal
